        ...
        <div id="carousel-slider" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <img src="<?php echo base_url(); ?>asset/images/banner/banner.jpg" class="img-responsive" alt="">
            </div>
            <div class="item">
              <img src="<?php echo base_url(); ?>asset/images/slider_one.jpg" class="img-responsive" alt="">
            </div>
          </div>
